...
public class Twitter {
	...
	public static final String CALLBACK_URI = "http://www.enjuego.com";
	public static final String CANCEL_URI = "http://www.enjuego.com";
	...
	public void authorize(Context ctx,
		...
		dialog(ctx, handler, new DialogListener() {
			...
			public void onComplete(Bundle values) {
				System.out.println("TWITTER authorize onComplete");
				CookieSyncManager.getInstance().sync();
				setAccessToken(values.getString(ACCESS_TOKEN));
				setSecretToken(values.getString(SECRET_TOKEN));
				if (isSessionValid()) {
					System.out.println("TWITTER token "+getAccessToken()+" "+getSecretToken());
