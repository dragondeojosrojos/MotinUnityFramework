...
public class OKLeaderboardsActivity extends FragmentActivity {
	...
	private static OKActivityHandler activityHandler;

	public static OKActivityHandler getActivityHandler() {
		return activityHandler;
	}

	public static void setActivityHandler(OKActivityHandler activityHandler) {
		OKLeaderboardsActivity.activityHandler = activityHandler;
	}
	...
	{
		super.onStop();
		OKLog.d("Dismiss OkLeaderboardActivity");
		callActivityHandler();
	}

	private void callActivityHandler()
	{
		if(getActivityHandler() != null) {
			getActivityHandler().onDialogComplete();
