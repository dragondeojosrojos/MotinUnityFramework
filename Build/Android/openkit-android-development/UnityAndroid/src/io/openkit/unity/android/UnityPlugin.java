...
import io.openkit.OKActivityHandler;
...
public class UnityPlugin {
	...
	public static void showAchievementsWithCallback(final String gameObjectName)
	{
		OKBridgeLog("Launching Leaderboards UI");
		
		OKLeaderboardsActivity.setActivityHandler(new OKActivityHandler() {

			@Override
			public void onDialogComplete() {
				String returnString = "OpenKit Achievements dialog finished";
		...
		UnityPlayer.currentActivity.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				leaderboards.putExtra(OKAchievement.OK_ACHIEVEMENT_KEY, true);
				UnityPlayer.currentActivity.startActivity(leaderboards);
				OKBridgeLog("Ended showLeaderboards function");
			}
		});
	}
	...
	public static void showLeaderboardsWithCallback(final String gameObjectName)
	{
		OKBridgeLog("Launching Leaderboards UI");
		...
		OKLeaderboardsActivity.setActivityHandler(new OKActivityHandler() {
			...
			@Override
			public void onDialogComplete() {
				String returnString = "OpenKit Leaderboards dialog finished";
				UnityPlayer.UnitySendMessage(gameObjectName, ASYNC_CALL_SUCCEEDED, returnString);
			}
		});
