...
public class MotinDataListEditor  : MotinDataEditor {
	...
	/*
	public static MotinDataListEditor Create(EditorWindow host,MotinDataEditor editor,System.Type type)
        {
			MotinDataListEditor motinEditor = new MotinDataListEditor();
	...
	*/
	public MotinDataListEditor(MotinDataEditor editor,System.Type type):base()
	{
		handleId = MotinEditorUtils.GetUniqueInteger();
		dataType = type;
		dataEditor = editor;
	}
	public MotinDataListEditor(EditorWindow host,MotinDataEditor editor,System.Type type): base(host)
	{
		handleId = MotinEditorUtils.GetUniqueInteger();
		dataType = type;
		dataEditor = editor;
