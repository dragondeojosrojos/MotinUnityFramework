...
public class AMOptionsFile : ScriptableObject {
	...
	public static AMOptionsFile loadFile() {
		...
		a.quickAdd_Combos.Add(new List<int> {(int)MotinAnimatorTimeline.Track.Property,(int)MotinAnimatorTimeline.Track.Event});
		//a.quickAdd_Combos.Add(new List<int> {(int)MotinAnimatorTimeline.Track.Translation,(int)MotinAnimatorTimeline.Track.Orientation});
		//a.quickAdd_Combos.Add(new List<int> {(int)MotinAnimatorTimeline.Track.Translation,(int)MotinAnimatorTimeline.Track.Rotation,(int)MotinAnimatorTimeline.Track.Animation});
