		...
		GUILayout.BeginHorizontal();
			...
			GUILayout.BeginHorizontal(GUILayout.Width((isInspectorOpen ? width_inspector_open : width_inspector_closed)));
				...
				GUILayout.BeginVertical(GUILayout.Width(width_inspector_closed));
					...
					GUI.DrawTexture(rectPropertiesButton,MotinAnimatorTimeline.getSkinTextureStyleState("properties_bg").background);
					GUI.color = Color.white;
	...
	void showGroup(int id, int group_lvl) {
		...
		GUILayout.BeginHorizontal();
			...
			if(hasTracks(grp)) {
				...
				GUI.DrawTexture(rectSelectAllTexture,MotinAnimatorTimeline.getSkinTextureStyleState("select_all").background);
				GUI.color = Color.white;
			}
