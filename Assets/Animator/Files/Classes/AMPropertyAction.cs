...
public class AMPropertyAction : AMAction {
	...
	public override void execute(int frameRate, float delay,string animatorId) {
		...
		if(fieldInfo != null) {
			if(hasCustomEase()) {
				if(AMPropertyTrack.isValueTypeNumeric(valueType)) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_val,"to",end_val,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector2) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_vect2,"to",end_vect2,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector3) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_vect3,"to",end_vect3,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Color) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_color,"to",end_color,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Rect) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_vect2,"to",end_vect2,"easecurve",easeCurve,"id",animatorId));
			} else {
				if(AMPropertyTrack.isValueTypeNumeric(valueType)) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_val,"to",end_val,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector2) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_vect2,"to",end_vect2,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector3) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_vect3,"to",end_vect3,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Color) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_color,"to",end_color,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Rect) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"fieldinfo",fieldInfo,"from",start_vect2,"to",end_vect2,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
			}
		} else if(propertyInfo != null) {
			if(hasCustomEase()) {
				if(AMPropertyTrack.isValueTypeNumeric(valueType)) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_val,"to",end_val,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector2) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_vect2,"to",end_vect2,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector3) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_vect3,"to",end_vect3,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Color) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_color,"to",end_color,"easecurve",easeCurve,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Rect) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_vect2,"to",end_vect2,"easecurve",easeCurve,"id",animatorId));
			} else {
				if(AMPropertyTrack.isValueTypeNumeric(valueType)) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_val,"to",end_val,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector2) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_vect2,"to",end_vect2,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Vector3) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_vect3,"to",end_vect3,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Color) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_color,"to",end_color,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
				if(valueType == (int)AMPropertyTrack.ValueType.Rect) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"propertyinfo",propertyInfo,"from",start_vect2,"to",end_vect2,"easetype",(AMTween.EaseType)easeType,"id",animatorId));
			}

		} else if(methodInfo != null) {
			if(hasCustomEase()) {
				if(valueType == (int)AMPropertyTrack.ValueType.MorphChannels) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"methodtype", "morph", "methodinfo",methodInfo,"from",start_morph.ToArray(),"to",end_morph.ToArray(),"easecurve",easeCurve,"id",animatorId));
			} else {
				if(valueType == (int)AMPropertyTrack.ValueType.MorphChannels) AMTween.PropertyTo(component,AMTween.Hash("delay",getWaitTime(frameRate, delay),"time",getTime(frameRate),"methodtype", "morph", "methodinfo",methodInfo,"from",start_morph.ToArray(),"to",end_morph.ToArray(),"easetype",(AMTween.EaseType)easeType,"id",animatorId));
			}
		} else {
			Debug.LogError("Animator: No FieldInfo or PropertyInfo set.");
		}
